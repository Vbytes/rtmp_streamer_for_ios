...
- (id)initWithSessionPreset:(NSString *)sessionPreset cameraPosition:(AVCaptureDevicePosition)cameraPosition; 
{
    ...
    _horizontallyMirrorFrontFacingCamera = YES;
    _horizontallyMirrorRearFacingCamera = NO;
...
-(BOOL)setTorchOn:(BOOL) torchOn
{
    ...
    if (_captureSession.inputs.count > 0) {
        AVCaptureDeviceInput* currentCameraInput = [_captureSession.inputs objectAtIndex:0];
